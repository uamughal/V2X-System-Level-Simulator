...
%   FIXPAR = SCENPARTABLES(SCENARIO,PROPAGCONDITION) Sets WIM scenario
%   specific parameters given in [1, Tables 4.5-4.9]. These parameters are
%   used in GENERATE_BULK_PAR to generate spatio-temporal channel
%   parameters for channel coefficient generation.
%
%   Ref. [1]: D1.1.2 V1.0, "WINNER II channel models"
%
%   See also WIMPARSET and GENERATE_BULK_PAR.

%   Authors: Pekka Kyösti (EBIT), Lassi Hentilä (EBIT), Daniela Laselva
%   (EBIT), Marko Milojevic (TUI), Mikko Alatossava (CWC/UOULU)
%
