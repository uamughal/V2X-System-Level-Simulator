function move_LTE_west11_UE(LTE_config,UEs,networkPathlossMap,eNodeBs)
...
y_range=[-ISD/sqrt(3)/2+2*lane_width,ISD/sqrt(3)-2*lane_width];  % [-137m,281m] (road line distance=418m )
...
%% First 8+8 vehicles are moving to north direction 
for u_ =45:52
    UEs(u_).move;        
