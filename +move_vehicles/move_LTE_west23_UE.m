function move_LTE_west23_UE(LTE_config,UEs,networkPathlossMap,eNodeBs)
...
y_range=[-ISD/sqrt(3)+4*lane_width,-ISD/sqrt(3)/2-2*lane_width];  % [-274m,-151m] (road line distance=123m )
...
%% second special 1+1 vehicles are moving to south direction 
for u_ =69
    UEs(u_).move;        
