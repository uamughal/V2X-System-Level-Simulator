function move_LTE_west22_UE(LTE_config,UEs,networkPathlossMap,eNodeBs)
...
y_range=[-ISD/sqrt(3)/2+2*lane_width,-4*lane_width];  % [-137m,-14m] (road line distance=123m )
...
%% First special 1+1 vehicles are moving to south direction 
for u_ =68
    UEs(u_).move;        
