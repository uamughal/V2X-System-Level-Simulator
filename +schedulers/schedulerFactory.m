classdef schedulerFactory
    ...
    methods(Static)
        function chek_whether_scheduler_is_defined(scheduler_type_string)
        ...
        function new_scheduler = create_scheduler(scheduler_type_string,scheduler_params,eNodeB)
            ...
            switch scheduler_type_string
                ...
                case 'broadcast'
                   new_scheduler =schedulers.broadcast(scheduler_params,eNodeB);  
                case 'uplink_lteScheduler'
                   new_scheduler =schedulers.uplink_lteScheduler(scheduler_params,eNodeB);
                otherwise
