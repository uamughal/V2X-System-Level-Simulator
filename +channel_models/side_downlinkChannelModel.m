classdef side_downlinkChannelModel < handle
    %SIDE_DOWNLINKCHANNELMODEL Summary of this class goes here
    %   Detailed explanation goes here
% Represents the sidelink channel model that a specific user possesses. Each UE
...
% (c) Josep Colom Ikuno, INTHFT, 2008
   ...
   methods
       % class constructor
       function obj = side_downlinkChannelModel(aUE)
           obj.attached_UE = aUE;
       end
