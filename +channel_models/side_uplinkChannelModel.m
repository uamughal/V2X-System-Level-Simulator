classdef side_uplinkChannelModel < handle
...
% (c) Josep Colom Ikuno, INTHFT, 2008
   ...
   methods
       % class constructor
       function obj = side_uplinkChannelModel(aUE,n_RB,num_streams,delay)
       ...
       % Retrieve a feedback from the broadcast channels buffer
       function retrieved_feedback1 = get_broadcast_feedback(obj)
           last_feedback = obj.feedback_buffer(obj.retrieve_index);
           current_tti = obj.attached_UE.clock.current_TTI;
           if (current_tti==last_feedback.TTI_idx+obj.feedback_delay)&&(last_feedback.TTI_idx~=0)
               retrieved_feedback1 = last_feedback;
           else
               retrieved_feedback1 = [];
           end
       end
