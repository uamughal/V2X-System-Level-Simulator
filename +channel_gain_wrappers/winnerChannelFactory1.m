classdef winnerChannelFactory1 < channel_gain_wrappers.channelFactory
    ...
    methods (Static)
        function winner_params = get_default_config(carrier_freq,nTX,nRX,speed)
            ...
            winner_params.Scenario               = 3;         % 1=A1, 2=A2, 3=B1, 4=B2, 5=B3, 6=B4, 7=B5a, 8=B5c, 9=B5f, 10=C1, 11=C2, 12=C3, 13=C4, 14=D1 and 15=D2a
    ...
    methods
        function obj = winnerChannelFactory1(bandwidth,winner_params,varargin)
